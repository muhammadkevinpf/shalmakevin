    ...
    <Container className="font-playfair px-4">
      ...
      <Row className="justify-content-center my-5">
        ...
        <Col md={{span:5, offset: 1}}>
          ...
          <Button variant="warning" className="fw-bold bgcolor-cream">
              <a href={mapsUrl} target="_blank" rel="noreferrer noopener">View on Map</a>
          </Button>
        </Col>
      </Row>
      <Row>
        <Col sm={{order: 1}} md={{ span: 5, offset:1, order: 2 }} className="pb-4 place-container">
          <img src={reception} alt="reception" className="w-100 h-100 rounded" />
        </Col>
